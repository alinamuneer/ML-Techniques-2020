...
#print(negative_features_list[5],negative_features_list[2],positive_features_list[1])
...
#print('Parameters of GDA : '+'\nφ : '+str(phi)+'\nµ0 :\n'+str(mean0_negative_vector)+'\nµ1:\n'+str(mean1_positive_vector)+'\nΣ:\n'+str(covariance_matrix))
...
predicted_result= ['Correct', 'Wrong']
result_weightage = [correct,error]
ax.bar(predicted_result,result_weightage)
plt.show()
